...
export const metadata: Metadata = {
  title: "Terms & Conditions | Maise",
  description: "Terms and Conditions for the Maise on-device TTS and ASR app by Mobile Artificial Intelligence.",
};
  ...
  return (
    <main className={style.page}>
      ...
      <div className={style.content}>
        <p>
          These terms and conditions apply to the Maise app (hereby referred to
          as &ldquo;Application&rdquo;) for mobile devices that was created by Mobile
        ...
        <section className={style.section}>
          ...
          <p>
            ...
            Such actions could expose your phone to malware, viruses, malicious
            programs, compromise your phone&apos;s security features, and may result
        ...
        <section className={style.section}>
          ...
          <p>
            ...
            if you use the application outside of your home territory without
            disabling data roaming. If you are not the bill payer for the device
            on which you are using the application, they assume that you have
        ...
        <section className={style.section}>
          ...
          <p>
            ...
            point. The application is currently available as per the requirements
            for the operating system (and for any additional systems they decide
            to extend the availability of the application to) may change, and you
            will need to download the updates if you want to continue using the
            application. The Service Provider does not guarantee that it will
            always update the application so that it is relevant to you and/or
            compatible with the particular operating system version installed on
            your device. However, you agree to always accept updates to the
            application when offered to you.
          </p>
          <p>
            The Service Provider may also wish to cease providing the application
